...
LAB119:    t412 = (t4 + 4);
    t413 = *((unsigned int *)t4);
    t414 = *((unsigned int *)t412);
    t415 = (t413 || t414);
    if (t415 > 0)
        goto LAB120;

LAB121:    t417 = *((unsigned int *)t4);
    t418 = (~(t417));
...
LAB123:    if (*((unsigned int *)t412) > 0)
        goto LAB124;

LAB125:    if (*((unsigned int *)t4) > 0)
        goto LAB126;

LAB127:    memcpy(t3, t421, 8);
...
LAB128:    t422 = (t0 + 7520);
    ...
    *((unsigned int *)t432) = (t434 | t428);
    xsi_driver_vfirst_trans(t422, 0, 1);
    t435 = (t0 + 7360);
    *((int *)t435) = 1;
...
LAB120:    t416 = ((char*)((ng0)));
    goto LAB121;

LAB122:    t421 = ((char*)((ng5)));
    goto LAB123;

LAB124:    xsi_vlog_unsigned_bit_combine(t3, 2, t416, 2, t421, 2);
    goto LAB128;

LAB126:    memcpy(t3, t416, 8);
    goto LAB128;
...
extern void work_m_00000000003133269973_3683593905_init()
{
	static char *pe[] = {(void *)Cont_24_0,(void *)Cont_30_1,(void *)Always_32_2};
	xsi_register_didat("work_m_00000000003133269973_3683593905", "isim/mips.exe.sim/work/m_00000000003133269973_3683593905.didat");
