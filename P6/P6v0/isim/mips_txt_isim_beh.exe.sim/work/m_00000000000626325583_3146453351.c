...
#endif
static const char *ng0 = "D:/BUAA_Undergraduate/23-24autumn/CO_hw/P6/P6v0/npc.v";
...
LAB80:    if (*((unsigned int *)t220) > 0)
        goto LAB81;

LAB82:    if (*((unsigned int *)t194) > 0)
        goto LAB83;

LAB84:    memcpy(t193, t233, 8);

LAB85:    goto LAB63;

LAB64:    xsi_vlog_unsigned_bit_combine(t145, 32, t176, 32, t193, 32);
    goto LAB68;
...
LAB77:    t224 = (t0 + 1048U);
    ...
    t224 = ((char*)((ng3)));
    memset(t226, 0, 8);
    xsi_vlog_unsigned_add(t226, 32, t225, 32, t224, 32);
    goto LAB78;
...
LAB81:    xsi_vlog_unsigned_bit_combine(t193, 32, t226, 32, t233, 32);
    goto LAB85;

LAB83:    memcpy(t193, t226, 8);
    goto LAB85;

}


extern void work_m_00000000000626325583_3146453351_init()
{
	static char *pe[] = {(void *)Cont_33_0};
	xsi_register_didat("work_m_00000000000626325583_3146453351", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000000626325583_3146453351.didat");
