...
#endif
static const char *ng0 = "D:/BUAA_Undergraduate/23-24autumn/CO_hw/P6/P6v0/controller.v";
...
LAB16:    t89 = (t0 + 34512);
    ...
    *((unsigned int *)t99) = (t101 | t95);
    xsi_driver_vfirst_trans(t89, 0, 4);
    t102 = (t0 + 31200);
    *((int *)t102) = 1;
...
LAB44:    memcpy(t70, t88, 8);

LAB45:    goto LAB27;

LAB28:    xsi_vlog_unsigned_bit_combine(t22, 5, t65, 5, t70, 5);
    goto LAB32;
...
LAB41:    xsi_vlog_unsigned_bit_combine(t70, 5, t83, 5, t88, 5);
    goto LAB45;

LAB43:    memcpy(t70, t83, 8);
    goto LAB45;
...
LAB58:    t436 = (t0 + 34640);
    ...
    *((unsigned int *)t446) = (t448 | t442);
    xsi_driver_vfirst_trans(t436, 0, 2);
    t449 = (t0 + 31232);
    *((int *)t449) = 1;
...
LAB54:    xsi_vlog_unsigned_bit_combine(t3, 3, t166, 3, t171, 3);
    goto LAB58;
...
LAB81:    xsi_vlog_unsigned_bit_combine(t171, 3, t235, 3, t240, 3);
    goto LAB85;
...
LAB108:    xsi_vlog_unsigned_bit_combine(t240, 3, t304, 3, t309, 3);
    goto LAB112;
...
LAB148:    xsi_vlog_unsigned_bit_combine(t328, 3, t392, 3, t397, 3);
    goto LAB152;
...
LAB161:    xsi_vlog_unsigned_bit_combine(t397, 3, t411, 3, t416, 3);
    goto LAB165;
...
LAB174:    xsi_vlog_unsigned_bit_combine(t416, 3, t430, 3, t435, 3);
    goto LAB178;
