...
#endif
static const char *ng0 = "D:/BUAA_Undergraduate/23-24autumn/CO_hw/P7/P7stand/DE_REG.v";
...
LAB63:    memcpy(t161, t181, 8);

LAB64:    t200 = (t0 + 3528);
    xsi_vlogvar_wait_assign_value(t200, t161, 0, 0, 32, 0LL);
...
LAB87:    if (*((unsigned int *)t20) > 0)
        goto LAB88;

LAB89:    memcpy(t6, t12, 8);
...
LAB72:    if (*((unsigned int *)t190) > 0)
        goto LAB73;

LAB74:    if (*((unsigned int *)t182) > 0)
        goto LAB75;

LAB76:    memcpy(t181, t199, 8);

LAB77:    goto LAB59;

LAB60:    xsi_vlog_unsigned_bit_combine(t161, 32, t176, 32, t181, 32);
    goto LAB64;

LAB62:    memcpy(t161, t176, 8);
    goto LAB64;
...
LAB73:    xsi_vlog_unsigned_bit_combine(t181, 32, t194, 32, t199, 32);
    goto LAB77;

LAB75:    memcpy(t181, t194, 8);
    goto LAB77;
...
LAB86:    xsi_vlog_unsigned_bit_combine(t6, 32, t27, 32, t12, 32);
    goto LAB90;
...
LAB99:    xsi_vlog_unsigned_bit_combine(t6, 32, t27, 32, t12, 32);
    goto LAB103;

LAB101:    memcpy(t6, t27, 8);
    goto LAB103;

LAB104:    xsi_set_current_line(57, ng0);
...
extern void work_m_00000000004210320199_1264842247_init()
{
	static char *pe[] = {(void *)Initial_34_0,(void *)Always_46_1};
	xsi_register_didat("work_m_00000000004210320199_1264842247", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000004210320199_1264842247.didat");
