...
#endif
static const char *ng0 = "D:/BUAA_Undergraduate/23-24autumn/CO_hw/P7/P7v0/toRAM.v";
...
LAB72:    t475 = (t0 + 5816);
    ...
    *((unsigned int *)t479) = (t486 | t480);
    t487 = *((unsigned int *)t485);
    *((unsigned int *)t485) = (t487 | t481);
    xsi_driver_vfirst_trans(t475, 0, 0);
    t488 = (t0 + 5560);
    *((int *)t488) = 1;
...
LAB82:    memcpy(t407, t210, 8);

LAB83:    memset(t439, 0, 8);
    t440 = (t407 + 4);
...
LAB154:    if (*((unsigned int *)t440) != 0)
        goto LAB155;

LAB156:    t448 = *((unsigned int *)t179);
...
LAB88:    if (*((unsigned int *)t223) < *((unsigned int *)t222))
        goto LAB87;

LAB86:    *((unsigned int *)t224) = 1;

LAB87:    memset(t228, 0, 8);
    t229 = (t224 + 4);
...
LAB94:    memcpy(t254, t228, 8);

LAB95:    memset(t286, 0, 8);
    t287 = (t254 + 4);
...
LAB147:    if (*((unsigned int *)t400) != 0)
        goto LAB148;

LAB149:    t408 = *((unsigned int *)t210);
...
LAB100:    if (*((unsigned int *)t241) > *((unsigned int *)t240))
        goto LAB99;

LAB98:    *((unsigned int *)t242) = 1;

LAB99:    memset(t246, 0, 8);
    t247 = (t242 + 4);
...
LAB102:    if (*((unsigned int *)t247) != 0)
        goto LAB103;

LAB104:    t255 = *((unsigned int *)t228);
...
LAB119:    if (*((unsigned int *)t300) < *((unsigned int *)t299))
        goto LAB118;

LAB117:    *((unsigned int *)t301) = 1;
...
LAB125:    memcpy(t331, t305, 8);

LAB126:    memset(t363, 0, 8);
    t364 = (t331 + 4);
...
LAB131:    if (*((unsigned int *)t318) > *((unsigned int *)t317))
        goto LAB130;

LAB129:    *((unsigned int *)t319) = 1;

LAB130:    memset(t323, 0, 8);
    t324 = (t319 + 4);
...
LAB133:    if (*((unsigned int *)t324) != 0)
        goto LAB134;

LAB135:    t332 = *((unsigned int *)t305);
...
LAB150:    t419 = *((unsigned int *)t407);
    t420 = *((unsigned int *)t413);
    *((unsigned int *)t407) = (t419 | t420);
    t421 = (t210 + 4);
    t422 = (t399 + 4);
    t423 = *((unsigned int *)t210);
    t424 = (~(t423));
...
extern void work_m_00000000000404181617_0700487581_init()
{
	static char *pe[] = {(void *)Cont_38_0,(void *)Cont_39_1,(void *)Cont_41_2,(void *)Cont_43_3,(void *)Always_45_4,(void *)Always_71_5};
	xsi_register_didat("work_m_00000000000404181617_0700487581", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000000404181617_0700487581.didat");
