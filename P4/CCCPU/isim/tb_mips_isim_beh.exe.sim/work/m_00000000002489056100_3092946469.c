...
#endif
static const char *ng0 = "D:/BUAA_Undergraduate/23-24autumn/CO_hw/P4/CCCPU/controller.v";
...
LAB100:    t429 = (t0 + 15904);
    ...
    *((unsigned int *)t439) = (t441 | t435);
    xsi_driver_vfirst_trans(t429, 0, 2);
    t442 = (t0 + 14688);
    *((int *)t442) = 1;
...
LAB96:    xsi_vlog_unsigned_bit_combine(t3, 3, t316, 3, t321, 3);
    goto LAB100;
...
LAB119:    t385 = ((char*)((ng15)));
    goto LAB120;

LAB121:    t392 = (t0 + 5488U);
    t393 = *((char **)t392);
    memset(t391, 0, 8);
    t392 = (t393 + 4);
...
LAB137:    if (*((unsigned int *)t391) > 0)
        goto LAB138;

LAB139:    memcpy(t390, t409, 8);

LAB140:    goto LAB122;

LAB123:    xsi_vlog_unsigned_bit_combine(t321, 3, t385, 3, t390, 3);
    goto LAB127;

LAB125:    memcpy(t321, t385, 8);
    goto LAB127;

LAB128:    *((unsigned int *)t391) = 1;
    goto LAB131;
...
LAB132:    t404 = ((char*)((ng11)));
    goto LAB133;

LAB134:    t411 = (t0 + 6128U);
    t412 = *((char **)t411);
    memset(t410, 0, 8);
    t411 = (t412 + 4);
...
LAB136:    xsi_vlog_unsigned_bit_combine(t390, 3, t404, 3, t409, 3);
    goto LAB140;

LAB138:    memcpy(t390, t404, 8);
    goto LAB140;
...
LAB145:    t423 = ((char*)((ng10)));
    goto LAB146;

LAB147:    t428 = ((char*)((ng1)));
    goto LAB148;

LAB149:    xsi_vlog_unsigned_bit_combine(t409, 3, t423, 3, t428, 3);
    goto LAB153;
